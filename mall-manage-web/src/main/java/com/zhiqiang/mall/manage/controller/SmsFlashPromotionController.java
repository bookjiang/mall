...
/**
 * @ClassName: SmsFlashPromotionController限时购活动管理
 * @description: TODO
 * @author: zhiqiang
 * @create: 2020/6/4 22:59
 */
@CrossOrigin
@Controller
...
public class SmsFlashPromotionController {
    ...
    public Object getItem(@RequestParam(value = "keyword", required = false) String keyword,
        ...
        PageInfo<SmsFlashPromotion> flashPromotionList = flashPromotionService.list(keyword, pageSize, pageNum);
