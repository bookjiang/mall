...
/**
 * @ClassName: SmsFlashPromotionProductRelationController限时购和商品关系管理
 * @description: TODO
 * @author: zhiqiang
 * @create: 2020/6/4 23:11
 */
@CrossOrigin
@Controller
...
public class SmsFlashPromotionProductRelationController {
    ...
    public CommonResult<CommonPage<SmsFlashPromotionProduct>> list(@RequestParam(value = "flashPromotionId") Long flashPromotionId,
        ...
        System.out.println("fdsf"+flashPromotionId);
        PageInfo<SmsFlashPromotionProduct> flashPromotionProductList = relationService.list(flashPromotionId, flashPromotionSessionId, pageSize, pageNum);
