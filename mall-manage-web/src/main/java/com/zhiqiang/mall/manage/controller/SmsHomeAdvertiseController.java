...
import com.zhiqiang.mall.service.SmsHomeAdvertiseService;
...
/**
 * @ClassName: SmsHomeAdvertiseController首页轮播广告管理
 * @description: TODO
 * @author: zhiqiang
 * @create: 2020/6/4 22:19
 */
@CrossOrigin
@Controller
...
public class SmsHomeAdvertiseController {
    ...
    public CommonResult<CommonPage<SmsHomeAdvertise>> list(@RequestParam(value = "name", required = false) String name,
        ...
        PageInfo<SmsHomeAdvertise> advertiseList = advertiseService.list(name, type, endTime, pageSize, pageNum);
