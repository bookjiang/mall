...
import com.zhiqiang.mall.model.UmsAdminLogin;
...
public class UmsAdminController {
    ...
    public CommonResult login(@RequestBody UmsAdminLogin umsAdminLogin, BindingResult result)
    {
        ...
        //修改登录时间应该在service中写，因为保持与登录日志中登录时间对应
        //UmsAdmin umsAdmin=new UmsAdmin();
       // umsAdmin.setUsername(umsAdminLogin.getUsername());
        //umsAdmin.setLoginTime(new Date());
        //int count=umsAdminService.updateByUserName(umsAdmin);
    ...
    public CommonResult<CommonPage<UmsAdmin>> list(@RequestParam(value = "keyword", required = false) String keyword,
        ...
        PageInfo<UmsAdmin> pageInfo = umsAdminService.list(keyword, pageSize, pageNum);
...
//    }
    ...
    @ApiOperation("修改用户账户启用状态")
    @RequestMapping(value = "/updateStatus/{id}", method = RequestMethod.POST)
    @ResponseBody
    public CommonResult updateStatus(@PathVariable Long id, @RequestParam(value = "status") Integer params)
    {
        System.out.println("id"+id+"fdf"+params);
        UmsAdmin umsAdmin=new UmsAdmin();
        umsAdmin.setId(id);
        umsAdmin.setStatus(params);
